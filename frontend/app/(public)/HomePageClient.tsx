...
const codeLines = [
  {
    tokens: [
      { t: "#include ", c: "text-pink-500 dark:text-pink-400" },
      { t: "<iostream>", c: "text-yellow-600 dark:text-yellow-300" },
    ],
  },
  {
    tokens: [
      { t: "using namespace ", c: "text-pink-500 dark:text-pink-400" },
      { t: "std", c: "text-blue-600 dark:text-blue-300" },
      { t: ";", c: "text-gray-500" },
    ],
  },
  { tokens: [] },
  {
    tokens: [
      { t: "int ", c: "text-pink-500 dark:text-pink-400" },
      { t: "main", c: "text-yellow-600 dark:text-yellow-300" },
      { t: "() {", c: "text-gray-600 dark:text-gray-300" },
    ],
  },
  {
    tokens: [
      { t: "    cout ", c: "text-blue-600 dark:text-blue-300" },
      { t: "<< ", c: "text-pink-500 dark:text-pink-400" },
      { t: '"ሰላም ዓለም!" ', c: "text-green-600 dark:text-green-400" },
      { t: "<< endl;", c: "text-gray-500" },
    ],
  },
  {
    tokens: [
      { t: "    cout ", c: "text-blue-600 dark:text-blue-300" },
      { t: "<< ", c: "text-pink-500 dark:text-pink-400" },
      { t: '"Hello, World!" ', c: "text-green-600 dark:text-green-400" },
      { t: "<< endl;", c: "text-gray-500" },
    ],
  },
  {
    tokens: [
      { t: "    return ", c: "text-pink-500 dark:text-pink-400" },
      { t: "0", c: "text-orange-500 dark:text-orange-300" },
      { t: ";", c: "text-gray-500" },
    ],
  },
...
const learningPath = [
  {
    ...
    cpp: [
      ...
      { en: "Debugging & compiler errors", am: "Debugging እና የኮምፓይለር መልዕክቶች" },
    ],
  },
  {
    ...
    cpp: [
      ...
      { en: "Recursion & problem solving", am: "Recursion እና ችግር መፍታት" },
    ],
  },
  {
    ...
    cpp: [
      ...
      {
        en: "Move semantics & smart pointers",
        am: "Move semantics እና smart pointers",
      },
    ],
  },
] as const;
...
const curriculumSectionCopy = {
  en: {
    ...
    intro:
      "The diagnostic places you at the right level. Each card shows beginner, intermediate, and advanced focus areas so you always know what comes next.",
    cta: "Take the diagnostic test →",
    topicSummary: (cppLen: number) => `C++ · ${cppLen} focus areas`,
  },
  am: {
    sectionLabel: "የትምህርት አቅጣጫ",
    title: "ከ መሰረት እስከ ከፍተኛ በተደራጅ መንገድ",
    intro: "የመጀመሪያ ፈተና ደረጃዎን ይወስናል። እያንዳንዱ ካርድ ሶስቱን ደረጃዎች በ C++ ያሳያል።",
    cta: "የመጀመሪያ ፈተና ይውሰዱ →",
    topicSummary: (cppLen: number) => `C++ · ${cppLen} ርዕሰ ጉዳዮች`,
  },
} as const;
...
const features = [
  {
    ...
    titleAm: "በሁለት ቋንቋ የተሰናዳ",
    headline: "Learn in the language you think in",
    headlineAm: "በሚያስቡበት ቋንቋ ይማሩ",
    ...
    bodyAm:
      "እያንዳንዱ ትምህርት፣ ጥያቄ እና የኤአይ ማብራሪያ በአማርኛ እና በእንግሊዝኛ ይገኛል። በአንድ ጠቅታ ይቀያይሩ። ምንም መረጃ አይጠፋም።",
    visual: (
      <div className="space-y-3">
        {[
          {
            lang: "አማ",
            text: "ተለዋዋጭ ማለት ዋጋ ለማስቀመጥ የሚያገለግል ቦታ ነው።",
            active: true,
          },
          {
            lang: "EN",
            text: "A variable is a named storage location for a value.",
            active: false,
          },
        ].map((l) => (
          <div
          ...
          >
            <span
              className={cn(
                "text-xs font-bold px-2 py-0.5 rounded-md flex-shrink-0 mt-0.5",
                l.active
  ...
  },
  {
    ...
    headlineAm: "እውነተኛ C++ ይጻፉ። እውነተኛ ውጤት ይመልከቱ።",
    body: "GCC runs C++ in the cloud. Hit run and see output in milliseconds. No installs, no configuration, no excuses.",
    bodyAm: "ምንም ማውረድ፣ ምንም ማዘጋጀት አያስፈልግም። ኮድዎን ይፃፉ እና በፍጥነት ውጤቱን ያግኙ።",
    visual: (
      <div className="rounded-xl bg-gray-900 dark:bg-black/60 border border-gray-700 dark:border-white/10 overflow-hidden font-mono text-sm">
        ...
        <div className="p-4 space-y-0.5">
          ...
          <p>
            ...
            <span className="text-green-400">"ሰላም!"</span>
            <span className="text-gray-400"> &lt;&lt; endl;</span>
          </p>
          <p>
  ...
  },
  {
    ...
    headlineAm: "ከ 30 ሰከንድ በላይ በፍጹም አይጠምዱም",
    ...
    bodyAm:
      "በትምህርቱ ዙሪያ ማንኛውንም ጥያቄ በአማርኛ ወይም በእንግሊዝኛ ይጠይቁ። ግልጽ ማብራሪያ ወዲያውኑ ያግኙ።",
    visual: (
      <div className="space-y-3">
        ...
        <div className="flex gap-3 justify-end">
          <div className="bg-blue-600 rounded-2xl rounded-tr-sm px-4 py-3 text-sm text-white max-w-[85%]">
            ፖይንተር የሌላ ተለዋዋጭ የማህደረ ትውስታ አድራሻ የሚያስቀምጥ ተለዋዋጭ ነው።{" "}
            <span className="opacity-70">int* p = &x;</span> ማለት p የ x አድራሻ ይዟል።
          </div>
...
const testimonials = [
  {
    ...
    text: "I struggled with C++ for two years. This platform explained pointers in Amharic in a way no English textbook ever could.",
    avatar: "AT",
    color: "#2563EB",
  },
  {
    ...
    text: "The live compiler is a game changer. I practice on my phone during commutes. No laptop needed.",
    avatar: "TM",
    color: "#0d9488",
  },
  {
    ...
    text: "I earned my Beginner certificate in 3 weeks. The streak system made me open the app every single day.",
    avatar: "DK",
    color: "#059669",
  },
  {
    ...
    text: "I recommend this to all my students. The bilingual approach removes the language barrier that blocks most Ethiopian learners.",
    avatar: "SH",
    color: "#d97706",
  },
  {
    ...
    text: "The AI tutor answered my questions better than Stack Overflow. And it speaks Amharic.",
    avatar: "YA",
    color: "#dc2626",
  },
  {
    ...
    text: "Went from zero to confident projects—the beginner, intermediate, and advanced steps are clear and map to real practice.",
    avatar: "HG",
    color: "#0891b2",
  },
];
...
const marqueeItems = [
  { en: "🌐 Bilingual Lessons", am: "🌐 ሁለት ቋንቋ ትምህርቶች" },
  { en: "⚙️ Live C++ Compiler", am: "⚙️ ቀጥታ የ C++ ኮምፓይለር" },
  { en: "🤖 AI Tutor in Amharic", am: "🤖 የአማርኛ AI አስተማሪ" },
  { en: "🏆 XP & Leaderboard", am: "🏆 ነጥቦች እና ደረጃ ሰንጠረዥ" },
  { en: "🎓 Verified Certificates", am: "🎓 የተረጋገጡ ሰርተፊኬቶች" },
  { en: "🔥 Daily Streaks", am: "🔥 የዕለት ተዕለት ክትትል" },
  { en: "📝 Quizzes & Exams", am: "📝 ጥያቄዎች እና ፈተናዎች" },
  { en: "🌱 Beginner Friendly", am: "🌱 ለጀማሪዎች ምቹ" },
  { en: "🔬 Advanced Topics", am: "🔬 ከፍተኛ አርእስቶች" },
  { en: "📱 Works on Mobile", am: "📱 በሞባይል ላይ ይሰራል" },
  { en: "🆓 Free Forever", am: "🆓 ለዘለአለም ነፃ" },
  { en: "⚡ Instant Feedback", am: "⚡ ፈጣን ምላሽ" },
];
    ...
    <div className="border-b border-gray-100 dark:border-white/5 last:border-0">
      ...
      >
        ...
        <span
          className={cn(
            ...
            open &&
              "rotate-45 border-blue-200 dark:border-blue-500/30 text-blue-600 dark:text-blue-400",
          )}
        >
          +
        </span>
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <p className="pb-5 text-sm text-gray-500 dark:text-gray-400 leading-relaxed pr-10">
              {a}
            </p>
          </motion.div>
        )}
    ...
    <section className="relative pt-28 pb-36 px-6 sm:px-10 lg:px-16 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none hidden dark:block overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 30%, rgb(37 99 235 / 0.14), transparent 55%)",
            animation: reduceMotion
              ? undefined
              : "hero-blob-1 22s ease-in-out infinite",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at center, rgb(13 148 136 / 0.14), transparent 65%)",
            animation: reduceMotion
              ? undefined
              : "hero-blob-2 28s ease-in-out infinite",
          }}
        />
      ...
      <div className="absolute inset-0 pointer-events-none dark:hidden overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 0%, rgb(219 234 254), transparent 70%)",
            animation: reduceMotion
              ? undefined
              : "hero-blob-2 26s ease-in-out infinite",
          }}
        />
      </div>
                ...
                <div className="flex -space-x-2.5">
                  {["AT", "TM", "DK", "SH", "YA"].map((init, i) => (
                    <motion.div
                      ...
                      transition={{
                        delay: reduceMotion ? 0 : 0.45 + i * 0.06,
                        type: "spring",
                        stiffness: 400,
                        damping: 22,
                      }}
                  ...
                  <div className="flex gap-0.5">
                    {[...Array(5)].map((_, i) => (
                      <motion.span
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{
                          delay: reduceMotion ? 0 : 0.75 + i * 0.05,
                        }}
          ...
          >
            <div className="relative">
              <motion.div
                ...
                style={{
                  background:
                    "conic-gradient(from 180deg at 50% 50%, rgb(59 130 246 / 0.15), rgb(13 148 136 / 0.14), rgb(34 211 238 / 0.12), rgb(59 130 246 / 0.15))",
                  filter: "blur(24px)",
                }}
                animate={
                  reduceMotion ? undefined : { rotate: [0, 3, 0, -3, 0] }
                }
                transition={{
                  duration: 20,
                  repeat: Infinity,
                ...
                <div className="rounded-2xl bg-white dark:bg-[#0d1117] border border-gray-200/90 dark:border-white/[0.09] shadow-[0_24px_80px_-12px_rgba(15,23,42,0.2)] dark:shadow-[0_28px_90px_-16px_rgba(0,0,0,0.65)] overflow-hidden ring-1 ring-black/[0.04] dark:ring-white/[0.06]">
                  <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100 dark:border-white/5 bg-gray-50/90 dark:bg-white/[0.025] backdrop-blur-sm">
                    ...
                    <motion.span
                      ...
                      animate={
                        reduceMotion ? undefined : { opacity: [1, 0.75, 1] }
                      }
                      transition={{
                        duration: 3,
                        repeat: Infinity,
              ...
              >
                <div className="px-3 py-2 rounded-lg border border-gray-200/90 dark:border-white/12 bg-white/95 dark:bg-[#0d1117]/95 backdrop-blur-md shadow-lg">
                  <p className="font-mono text-xs text-orange-500 dark:text-orange-400">
                    🔥 14 day streak
                  </p>
                </div>
              </motion.div>
...
export default function LandingPage() {
  ...
  const curriculumLocale =
    i18n.language === "am" || i18n.language === "amh" ? "am" : "en";
  ...
  useEffect(() => {
    const t = setInterval(
      () => setActiveFeature((v) => (v + 1) % features.length),
      4000,
    );
      ...
      <div className="relative z-10">
        ...
        >
          <div className="max-w-screen-xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            <StatCard
              value={500}
              suffix="+"
              label={curriculumLocale === "am" ? "ንቁ ተማሪዎች" : "Active learners"}
              start={statsInView}
            />
            <StatCard
              value={50}
              suffix="+"
              label={
                curriculumLocale === "am" ? "የሚገኙ ትምህርቶች" : "Lessons available"
              }
              start={statsInView}
            />
            <StatCard
              value={3}
              suffix=""
              label={curriculumLocale === "am" ? "የክህሎት ደረጃዎች" : "Skill levels"}
              start={statsInView}
            />
            <StatCard
              value={100}
              suffix="%"
              label={curriculumLocale === "am" ? "ለመጀመር ነጻ" : "Free to start"}
              start={statsInView}
            />
          </div>
        </section>
            ...
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              <div className="flex-1 max-w-lg">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-2">
                  <SectionLabel>{t("curriculum.sectionLabel")}</SectionLabel>
                  <div
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => i18n.changeLanguage("amh")}
                      className={cn(
                        "px-3.5 py-1.5 text-xs font-semibold rounded-lg transition-colors",
                        curriculumLocale === "am"
                          ? "bg-white dark:bg-white/10 text-gray-900 dark:text-white shadow-sm"
                ...
                <p
                  className={cn(
                    ...
                    curriculumLocale === "am" &&
                      `${notoEthiopic.className} text-[15px] sm:text-base`,
                  )}
                >
                  {t("curriculum.intro")}
                </p>
                    ...
                    <div className="relative flex items-center gap-4 px-6 py-4 border-b border-gray-100 dark:border-white/5">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-semibold text-gray-900 dark:text-white">
                          {level.level[curriculumLocale]}
                        </p>
                        <p className="text-xs text-gray-400 dark:text-gray-500">
                          {curriculumSectionCopy[curriculumLocale].topicSummary(
                            level.cpp.length,
                          )}
                        </p>
                      </div>
                      <div
                        className={cn(
                          "w-2.5 h-2.5 rounded-full ring-2 ring-white dark:ring-[#080810] flex-shrink-0",
                          level.color,
                        )}
                      />
                    </div>
        ...
        <section className="py-24 overflow-hidden border-y border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-white/[0.015]">
          <div className="px-6 sm:px-10 lg:px-16 mb-10">
            <FadeUp>
              <SectionLabel>
                {curriculumLocale === "am" ? "ፕሮጀክቶች" : "Projects"}
              </SectionLabel>
              ...
              <p className="mt-3 text-gray-500 dark:text-gray-400 max-w-lg">
                {curriculumLocale === "am"
                  ? "በእያንዳንዱ ደረጃ እውነተኛ ፕሮጀክቶች—የኮማንድ ላይን ቱሎች፣ ዳታ ስትራክቸር እና አነስተኛ ሲስተሞች።"
                  : "Real projects at every level—command-line tools, data structures, and small systems you can run, share, or put in a portfolio."}
              </p>
            </FadeUp>
          </div>
          ...
          <div
            className="flex gap-5 overflow-x-auto pb-6 px-6 sm:px-10 lg:px-16 snap-x snap-mandatory scrollbar-hide"
          ...
          >
            {[
              ...
              },
              {
                ...
                level: "Beginner",
                icon: Layout,
                title: "Student grade book (CLI)",
                desc: "Add courses and scores in memory, print a formatted report, and validate bad input.",
                tags: ["Structs", "Vectors", "I/O"],
                color:
                  "border-emerald-200 dark:border-emerald-500/20 bg-emerald-50/50 dark:bg-emerald-500/5",
              },
              {
                ...
                desc: "Log purchases to a text file, reload on startup, and summarize totals by category.",
                tags: ["File I/O", "Strings", "Loops"],
                color:
                  "border-emerald-200 dark:border-emerald-500/20 bg-emerald-50/50 dark:bg-emerald-500/5",
              },
              {
              ...
              },
              {
                ...
                title: "Inventory CLI",
                desc: "Add, list, and remove SKUs with a simple menu; persist inventory to disk between sessions.",
                tags: ["Classes", "Vectors", "File I/O"],
                color:
                  "border-blue-200 dark:border-blue-500/20 bg-blue-50/50 dark:bg-blue-500/5",
              },
              {
                ...
                desc: "Parse key=value lines from a config file to toggle features and tune limits at runtime.",
                tags: ["Parsing", "Maps", "Error handling"],
                color:
                  "border-blue-200 dark:border-blue-500/20 bg-blue-50/50 dark:bg-blue-500/5",
              },
              {
                ...
                color:
                  "border-teal-200 dark:border-teal-500/25 bg-teal-50/60 dark:bg-teal-500/8",
              },
              {
                track: "cpp" as const,
                level: "Advanced",
              ...
              },
              {
                ...
                level: "Advanced",
                icon: ListTodo,
                title: "Task scheduler (in-memory)",
                desc: "Priority queue of jobs with dependencies; simulate execution order and detect cycles.",
                tags: ["STL", "Graphs", "Algorithms"],
                color:
                  "border-teal-200 dark:border-teal-500/25 bg-teal-50/60 dark:bg-teal-500/8",
              },
              {
                ...
                level: "Advanced",
                icon: Cloud,
                title: "HTTP log analyzer",
                desc: "Stream a large log file, aggregate status codes and paths, and print ranked summaries.",
                tags: ["I/O", "Maps", "Performance"],
                color:
                  "border-teal-200 dark:border-teal-500/25 bg-teal-50/60 dark:bg-teal-500/8",
              },
            ].map((project, i) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5 mt-auto">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-xs px-2.5 py-1 rounded-full bg-white/70 dark:bg-white/5 border border-gray-200 dark:border-white/8 text-gray-600 dark:text-gray-400 font-medium"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                {features.map((f, i) => (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      >
                        {curriculumLocale === "am" ? f.titleAm : f.title}
                      </p>
                    </div>
                    {activeFeature === i && (
                      <ArrowRight className="ml-auto w-4 h-4 text-blue-600 dark:text-blue-400 hidden lg:block" />
                    )}
                  </motion.button>
                ))}
              </div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                      {curriculumLocale === "am"
                        ? features[activeFeature].headlineAm
                        : features[activeFeature].headline}
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-8">
                      {curriculumLocale === "am"
                        ? features[activeFeature].bodyAm
        ...
        <section className="relative py-28 px-6 sm:px-10 lg:px-16 overflow-hidden">
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="text-center mb-16">
              <SectionLabel>
                {curriculumLocale === "am" ? "ሂደት" : "Process"}
              </SectionLabel>
              <h2 className="mt-4 text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white tracking-tight">
                {curriculumLocale === "am"
                  ? "ግልፅ የሆነ መንገድ ከመጀመሪያው ቀን ጀምሮ"
                  : "A clear path from day one"}
              </h2>
              <p className="mt-4 text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                {curriculumLocale === "am"
                  ? "ደረጃዎን ይወቁ፣ በራስዎ ፍጥነት ይማሩ፣ እና ሰርተፊኬቶች ያግኙ።"
              ...
              {[
                {
                  ...
                  desc: "Answer 15 C++ placement questions. We place you at Beginner, Intermediate, or Advanced automatically.",
                },
                {
                  num: "02",
                  icon: BookOpenCheck,
                  title: "Follow your path",
                  desc: "Work through bilingual lessons at your level—console C++. Run code in the browser. Ask the AI tutor when stuck.",
                },
                {
                  num: "03",
                  icon: Medal,
                  title: "Earn your certificate",
                  desc: "Pass quizzes, complete the level, and receive a verified certificate with a public verification link.",
                },
              ].map((s, si) => (
                <motion.div
                  key={s.num}
                ...
                >
                  ...
                  <div className="relative flex items-start gap-5 mb-6">
                    ...
                    <span className="text-5xl font-black text-gray-100 dark:text-white/8 font-mono select-none leading-none mt-1">
                      {s.num}
                    </span>
                  </div>
                  <h3 className="relative font-bold text-gray-900 dark:text-white text-lg mb-2">
                    {s.title}
                  </h3>
              ...
              {testimonials.map((t, ti) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-gray-100 dark:border-white/5">
                    <div
                      className="w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0 ring-2 ring-white dark:ring-[#0a0a12] shadow-md"
        ...
        <section className="relative py-24 px-6 sm:px-10 lg:px-16 overflow-hidden">
          ...
          <div className="max-w-screen-xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                <p className="text-blue-600 dark:text-blue-400 text-sm font-semibold uppercase tracking-widest mb-6">
                  The numbers speak
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-0 sm:divide-x divide-gray-200 dark:divide-white/8">
                  {[
                    ...
                    {
                      num: "3",
                      label: "Placement levels (Beginner → Advanced)",
                    },
        ...
        <section className="py-28 px-6 sm:px-10 lg:px-16">
          <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row gap-16">
            <div className="lg:w-80 flex-shrink-0">
              ...
              <Link
                href="/faq"
                className="mt-4 inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold text-sm hover:gap-3 transition-all duration-200"
              >
                View all FAQs →
              </Link>
              <Link
            ...
            <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">
                          Level 12 · Intermediate · C++ curriculum
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <div
                        key={b.label}
                        className={cn(
                          "flex items-center gap-2 px-3 py-2 rounded-xl border text-xs font-medium text-gray-700 dark:text-gray-300",
                          b.color,
                        )}
                      >
              ...
              <div className="flex-1 max-w-lg">
                ...
                <p className="mt-5 text-gray-500 dark:text-gray-400 leading-relaxed">
                  Every lesson earns XP. Every quiz earns coins. Maintain your
                  streak and climb the leaderboard. The platform is designed to
                  make consistent learning feel rewarding, not like a chore.
                </p>
                  ...
                  {[
                    {
                      icon: Zap,
                      title: "XP & Levels",
                      desc: "Earn experience points for every lesson and quiz you complete.",
                    },
                    {
                      icon: Flame,
                      title: "Daily Streaks",
                      desc: "Grows when you sign in each day—separate from XP from lessons and quizzes.",
                    },
                    {
                      icon: Trophy,
                      title: "Leaderboard",
                      desc: "Compete with friends and students at your level.",
                    },
                  ].map((item) => (
          ...
          <div className="max-w-screen-xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="flex-1 max-w-lg">
                ...
                <p className="mt-5 text-gray-500 dark:text-gray-400 leading-relaxed">
                  Complete a level and earn a PDF certificate with your name,
                  level, and a unique verification ID. Share it on LinkedIn,
                  send it to employers, or just keep it for yourself.
                </p>
                ...
                <Link
                  href="/sign-up"
                  className="mt-8 inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 font-semibold text-sm hover:gap-3 transition-all duration-200"
                >
              ...
              <div className="relative flex flex-col md:flex-row items-center justify-between gap-10 px-10 sm:px-16 py-16">
                <div className="text-center md:text-left">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-400 max-w-md">
                    Free forever. No credit card. No setup. Just open your
                    browser and write your first program in Amharic.
                  </p>
                  <div className="mt-5 flex flex-wrap gap-4 justify-center md:justify-start text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <span className="flex items-center gap-1.5">
                      <CheckCircle2 className="w-4 h-4 text-green-500" /> Live
                      compiler
                    </span>
                    <span className="flex items-center gap-1.5">
                ...
                <div className="flex flex-col gap-3 flex-shrink-0 w-full sm:w-auto">
                  {isLoggedIn ? (
                    <Link
                      href="/dashboard"
                      className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-blue-600 text-white font-bold text-base hover:bg-blue-500 transition-all duration-200 shadow-md shadow-blue-500/15 hover:-translate-y-0.5 whitespace-nowrap"
                    >
                      Go to Dashboard →
                    </Link>
                  ) : (
                    <>
                      ...
                      <Link
                        href="/sign-in"
                        className="inline-flex items-center justify-center px-8 py-4 rounded-xl border border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 font-semibold text-base hover:bg-gray-50 dark:hover:bg-white/5 transition-colors whitespace-nowrap text-center"
                      >
